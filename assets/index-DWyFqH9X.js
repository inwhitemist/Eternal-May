const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AuthDialog-DFSj0FNQ.js","assets/x-Bd82xhcZ.js","assets/AddDialog-CHteESKI.js","assets/chevron-down-BkoAtKzR.js","assets/DetailDialog-Bw-qQIDB.js","assets/AdminDialog-kQw2nq1P.js"])))=>i.map(i=>d[i]);
...
`,H0=8,B3={x:2,y:-.7,rotate:-1};function z3(t){let e=t.trim();e.startsWith("#")&&(e=e.slice(1));let n=255,i=255,r=255;return e.length===3?(n=parseInt(e[0]+e[0],16),i=parseInt(e[1]+e[1],16),r=parseInt(e[2]+e[2],16)):e.length===6&&(n=parseInt(e.slice(0,2),16),i=parseInt(e.slice(2,4),16),r=parseInt(e.slice(4,6),16)),new B(n/255,i/255,r/255)}function V3({linesGradient:t,enabledWaves:e=["top","middle","bottom"],lineCount:n=[6],lineDistance:i=[5],topWavePosition:r,middleWavePosition:s,bottomWavePosition:o=B3,animationSpeed:a=1,interactive:l=!0,bendRadius:u=5,bendStrength:c=-.5,mouseDamping:f=.05,parallax:h=!0,parallaxStrength:p=.2,mixBlendMode:m="screen"}){const x=W.useRef(null),g=W.useRef(new Ze(-1e3,-1e3)),d=W.useRef(new Ze(-1e3,-1e3)),v=W.useRef(0),_=W.useRef(0),y=W.useRef(new Ze(0,0)),w=W.useRef(new Ze(0,0)),A=V=>{if(typeof n=="number")return n;if(!e.includes(V))return 0;const te=e.indexOf(V);return n[te]??6},C=V=>{if(typeof i=="number")return i;if(!e.includes(V))return .1;const te=e.indexOf(V);return i[te]??.1},R=e.includes("top")?A("top"):0,T=e.includes("middle")?A("middle"):0,E=e.includes("bottom")?A("bottom"):0,D=e.includes("top")?C("top")*.01:.01,$=e.includes("middle")?C("middle")*.01:.01,j=e.includes("bottom")?C("bottom")*.01:.01;return W.useEffect(()=>{if(!x.current)return;const V=new XR,te=new aE(-1,1,1,-1,0,1);te.position.z=1;const G=new F3({antialias:!0,alpha:!1});G.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),G.domElement.style.width="100%",G.domElement.style.height="100%",x.current.appendChild(G.domElement);const ee={iTime:{value:0},iResolution:{value:new B(1,1,1)},animationSpeed:{value:a},enableTop:{value:e.includes("top")},enableMiddle:{value:e.includes("middle")},enableBottom:{value:e.includes("bottom")},topLineCount:{value:R},middleLineCount:{value:T},bottomLineCount:{value:E},topLineDistance:{value:D},middleLineDistance:{value:$},bottomLineDistance:{value:j},topWavePosition:{value:new B((r==null?void 0:r.x)??10,(r==null?void 0:r.y)??.5,(r==null?void 0:r.rotate)??-.4)},middleWavePosition:{value:new B((s==null?void 0:s.x)??5,(s==null?void 0:s.y)??0,(s==null?void 0:s.rotate)??.2)},bottomWavePosition:{value:new B((o==null?void 0:o.x)??2,(o==null?void 0:o.y)??-.7,(o==null?void 0:o.rotate)??.4)},iMouse:{value:new Ze(-1e3,-1e3)},interactive:{value:l},bendRadius:{value:u},bendStrength:{value:c},bendInfluence:{value:0},parallax:{value:h},parallaxStrength:{value:p},parallaxOffset:{value:new Ze(0,0)},lineGradient:{value:Array.from({length:H0},()=>new B(1,1,1))},lineGradientCount:{value:0}};if(t&&t.length>0){const Se=t.slice(0,H0);ee.lineGradientCount.value=Se.length,Se.forEach((Te,Pe)=>{const We=z3(Te);ee.lineGradient.value[Pe].set(We.x,We.y,We.z)})}const N=new Gi({uniforms:ee,vertexShader:O3,fragmentShader:k3}),q=new qa(2,2),Q=new hi(q,N);V.add(Q);const fe=new JR,ve=()=>{const Se=x.current,Te=Se.clientWidth||1,Pe=Se.clientHeight||1;G.setSize(Te,Pe,!1);const We=G.domElement.width,ke=G.domElement.height;ee.iResolution.value.set(We,ke,1)};ve();const Ye=typeof ResizeObserver<"u"?new ResizeObserver(ve):null;Ye&&x.current&&Ye.observe(x.current);const Ve=Se=>{if(!x.current)return;const Te=x.current.getBoundingClientRect(),Pe=Te.width||1,We=Te.height||1,ke=G.getPixelRatio(),L=Se.clientX-Te.left,qe=Se.clientY-Te.top,Re=Math.min(Math.max(L,0),Pe),je=Math.min(Math.max(qe,0),We),Ee=L>=0&&L<=Pe&&qe>=0&&qe<=We;if(g.current.set(Re*ke,(We-je)*ke),v.current=Ee?1:0,h)if(Ee){const Je=Re/Pe-.5,ge=-(je/We-.5);y.current.set(Je*p,ge*p)}else y.current.set(0,0)},X=()=>{v.current=0,h&&y.current.set(0,0)};l&&(window.addEventListener("pointermove",Ve),window.addEventListener("pointerleave",X));let le=0;const se=()=>{ee.iTime.value=fe.getElapsedTime(),l&&(d.current.lerp(g.current,f),ee.iMouse.value.copy(d.current),_.current+=(v.current-_.current)*f,ee.bendInfluence.value=_.current),h&&(w.current.lerp(y.current,f),ee.parallaxOffset.value.copy(w.current)),G.render(V,te),le=requestAnimationFrame(se)};return se(),()=>{cancelAnimationFrame(le),Ye&&x.current&&Ye.disconnect(),l&&(window.removeEventListener("pointermove",Ve),window.removeEventListener("pointerleave",X)),q.dispose(),N.dispose(),G.dispose(),G.domElement.parentElement&&G.domElement.parentElement.removeChild(G.domElement)}},[t,e,n,i,r,s,o,a,l,u,c,f,h,p]),b.jsx("div",{ref:x,className:"w-full h-full relative overflow-hidden floating-lines-container",style:{mixBlendMode:m}})}/**
...
`)}function uN({query:t,setQuery:e,year:n,setYear:i,month:r,setMonth:s,activeTags:o,setActiveTags:a,years:l,allTags:u,resetFilters:c,resultsCount:f,admin:h,onAdd:p}){return b.jsxs("section",{className:"-mt-6 mb-6 rounded-3xl border border-black/10 bg-white/70 p-4 shadow-xl backdrop-blur dark:border-white/10 dark:bg-white/5",children:[b.jsxs("div",{className:"flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between",children:[b.jsxs("div",{className:"flex flex-1 items-center gap-2",children:[b.jsxs("div",{className:"relative w-full",children:[b.jsx(nN,{className:"pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 opacity-60",size:18}),b.jsx(vE,{className:"pl-10",placeholder:"Поиск по событиям, описаниям и тегам",value:t,onChange:m=>e(m.target.value)})]}),b.jsx(Lt,{variant:"soft",onClick:c,children:b.jsx(Z3,{size:16})}),h&&b.jsxs(Lt,{onClick:p,children:[b.jsx(tN,{size:16})," Новое"]})]}),b.jsxs("div",{className:"text-xs opacity-70",children:["Найдено ",f," событий"]})]}),b.jsxs("div",{className:"mt-4 grid gap-4 md:grid-cols-3",children:[b.jsxs("div",{children:[b.jsx("div",{className:"mb-2 text-xs font-semibold uppercase tracking-wide opacity-70",children:"Годы"}),b.jsxs("div",{className:"flex flex-wrap gap-2",children:[b.jsx(Oo,{label:"Все",selected:n==="all",onClick:()=>i("all")}),l.map(m=>b.jsx(Oo,{label:String(m),selected:n===m,onClick:()=>i(m)},m))]})]}),b.jsxs("div",{children:[b.jsx("div",{className:"mb-2 text-xs font-semibold uppercase tracking-wide opacity-70",children:"Месяцы"}),b.jsxs("div",{className:"flex flex-wrap gap-2",children:[b.jsx(Oo,{label:"Все",selected:r==="all",onClick:()=>s("all")}),xE.map((m,x)=>b.jsx(Oo,{label:m.slice(0,3),selected:r===x,onClick:()=>s(x)},m))]})]}),u.length?b.jsxs("div",{children:[b.jsx("div",{className:"mb-2 text-xs font-semibold uppercase tracking-wide opacity-70",children:"Теги"}),b.jsx("div",{className:"flex flex-wrap gap-2",children:u.map(m=>b.jsx(Oo,{label:m,selected:o.includes(m),onClick:()=>a(x=>x.includes(m)?x.filter(g=>g!==m):[...x,m])},m))})]}):b.jsx("div",{})]})]})}function cN(){return b.jsxs("div",{className:"group relative flex h-45 w-full flex-col overflow-hidden rounded-3xl border border-black/10 bg-white/70 p-5 shadow-lg backdrop-blur dark:border-white/10 dark:bg-white/5",style:{contentVisibility:"auto",containIntrinsicSize:"280px 180px"},"aria-hidden":!0,children:[b.jsx("div",{className:"absolute inset-x-4 top-0 h-1 rounded-b-full bg-black/10 dark:bg-white/10"}),b.jsxs("div",{className:"relative z-[1] flex h-full flex-col",children:[b.jsxs("div",{className:"flex items-center gap-2",children:[b.jsx("div",{className:"h-4 w-4 rounded-full bg-black/10 dark:bg-white/10"}),b.jsx("div",{className:"h-4 w-2/3 rounded bg-black/10 dark:bg-white/10"})]}),b.jsx("div",{className:"mt-3",children:b.jsx("div",{className:"h-5 w-24 rounded-full bg-black/10 dark:bg-white/10"})}),b.jsxs("div",{className:"mt-3 space-y-2",children:[b.jsx("div",{className:"h-3 w-11/12 rounded bg-black/10 dark:bg-white/10"}),b.jsx("div",{className:"h-3 w-4/5 rounded bg-black/10 dark:bg-white/10"})]}),b.jsxs("div",{className:"mt-auto pt-3 flex flex-wrap gap-2",children:[b.jsx("div",{className:"h-5 w-16 rounded-full bg-black/10 dark:bg-white/10"}),b.jsx("div",{className:"h-5 w-20 rounded-full bg-black/10 dark:bg-white/10"}),b.jsx("div",{className:"h-5 w-14 rounded-full bg-black/10 dark:bg-white/10"})]})]}),b.jsx("div",{className:"absolute inset-0 animate-pulse bg-gradient-to-r from-transparent via-black/5 to-transparent"})]})}function fN({count:t=8}){return b.jsx("div",{className:"relative grid gap-5 sm:gap-6 md:grid-cols-2 mx-auto w-full max-w-5xl",children:Array.from({length:t}).map((e,n)=>b.jsx(cN,{},n))})}const dN=({children:t,color:e="#5227FF",speed:n=1,chaos:i=1,thickness:r=2,className:s,style:o})=>{const l=`turbulent-displace-${W.useId().replace(/[:]/g,"")}`,u=W.useRef(null),c=W.useRef(null),f=W.useRef(null),h=()=>{const m=u.current,x=c.current;if(!m||!x)return;f.current&&(f.current.style.filter=`url(#${l})`);const g=Math.max(1,Math.round(x.clientWidth||x.getBoundingClientRect().width||0)),d=Math.max(1,Math.round(x.clientHeight||x.getBoundingClientRect().height||0)),v=Array.from(m.querySelectorAll('feOffset > animate[attributeName="dy"]'));v.length>=2&&(v[0].setAttribute("values",`${d}; 0`),v[1].setAttribute("values",`0; -${d}`));const _=Array.from(m.querySelectorAll('feOffset > animate[attributeName="dx"]'));_.length>=2&&(_[0].setAttribute("values",`${g}; 0`),_[1].setAttribute("values",`0; -${g}`));const w=Math.max(.001,6/(n||1));[...v,..._].forEach(R=>R.setAttribute("dur",`${w}s`));const A=m.querySelector("feDisplacementMap");A&&A.setAttribute("scale",String(30*(i||1)));const C=m.querySelector(`#${CSS.escape(l)}`);C&&(C.setAttribute("x","-200%"),C.setAttribute("y","-200%"),C.setAttribute("width","500%"),C.setAttribute("height","500%")),requestAnimationFrame(()=>{[...v,..._].forEach(R=>{if(typeof R.beginElement=="function")try{R.beginElement()}catch{console.warn("ElectricBorder: beginElement failed, this may be due to a browser limitation.")}})})};W.useEffect(()=>{h()},[n,i]),W.useLayoutEffect(()=>{if(!c.current)return;const m=new ResizeObserver(()=>h());return m.observe(c.current),h(),()=>m.disconnect()},[]);const p={"--electric-border-color":e,"--eb-border-width":`${r}px`};return b.jsxs("div",{ref:c,className:`electric-border ${s??""}`,style:{...p,...o},children:[b.jsx("svg",{ref:u,className:"eb-svg","aria-hidden":!0,focusable:"false",children:b.jsx("defs",{children:b.jsxs("filter",{id:l,colorInterpolationFilters:"sRGB",x:"-20%",y:"-20%",width:"140%",height:"140%",children:[b.jsx("feTurbulence",{type:"turbulence",baseFrequency:"0.02",numOctaves:"10",result:"noise1",seed:"1"}),b.jsx("feOffset",{in:"noise1",dx:"0",dy:"0",result:"offsetNoise1",children:b.jsx("animate",{attributeName:"dy",values:"700; 0",dur:"6s",repeatCount:"indefinite",calcMode:"linear"})}),b.jsx("feTurbulence",{type:"turbulence",baseFrequency:"0.02",numOctaves:"10",result:"noise2",seed:"1"}),b.jsx("feOffset",{in:"noise2",dx:"0",dy:"0",result:"offsetNoise2",children:b.jsx("animate",{attributeName:"dy",values:"0; -700",dur:"6s",repeatCount:"indefinite",calcMode:"linear"})}),b.jsx("feTurbulence",{type:"turbulence",baseFrequency:"0.02",numOctaves:"10",result:"noise1",seed:"2"}),b.jsx("feOffset",{in:"noise1",dx:"0",dy:"0",result:"offsetNoise3",children:b.jsx("animate",{attributeName:"dx",values:"490; 0",dur:"6s",repeatCount:"indefinite",calcMode:"linear"})}),b.jsx("feTurbulence",{type:"turbulence",baseFrequency:"0.02",numOctaves:"10",result:"noise2",seed:"2"}),b.jsx("feOffset",{in:"noise2",dx:"0",dy:"0",result:"offsetNoise4",children:b.jsx("animate",{attributeName:"dx",values:"0; -490",dur:"6s",repeatCount:"indefinite",calcMode:"linear"})}),b.jsx("feComposite",{in:"offsetNoise1",in2:"offsetNoise2",result:"part1"}),b.jsx("feComposite",{in:"offsetNoise3",in2:"offsetNoise4",result:"part2"}),b.jsx("feBlend",{in:"part1",in2:"part2",mode:"color-dodge",result:"combinedNoise"}),b.jsx("feDisplacementMap",{in:"SourceGraphic",in2:"combinedNoise",scale:"30",xChannelSelector:"R",yChannelSelector:"B"})]})})}),b.jsxs("div",{className:"eb-layers",children:[b.jsx("div",{ref:f,className:"eb-stroke"}),b.jsx("div",{className:"eb-glow-1"}),b.jsx("div",{className:"eb-glow-2"}),b.jsx("div",{className:"eb-background-glow"})]}),b.jsx("div",{className:"eb-content",children:t})]})};class ui{constructor(e,n={}){if(!(e instanceof Node))throw"Can't initialize VanillaTilt because "+e+" is not a Node.";this.width=null,this.height=null,this.clientWidth=null,this.clientHeight=null,this.left=null,this.top=null,this.gammazero=null,this.betazero=null,this.lastgammazero=null,this.lastbetazero=null,this.transitionTimeout=null,this.updateCall=null,this.event=null,this.updateBind=this.update.bind(this),this.resetBind=this.reset.bind(this),this.element=e,this.settings=this.extendSettings(n),this.reverse=this.settings.reverse?-1:1,this.resetToStart=ui.isSettingTrue(this.settings["reset-to-start"]),this.glare=ui.isSettingTrue(this.settings.glare),this.glarePrerender=ui.isSettingTrue(this.settings["glare-prerender"]),this.fullPageListening=ui.isSettingTrue(this.settings["full-page-listening"]),this.gyroscope=ui.isSettingTrue(this.settings.gyroscope),this.gyroscopeSamples=this.settings.gyroscopeSamples,this.elementListener=this.getElementListener(),this.glare&&this.prepareGlare(),this.fullPageListening&&this.updateClientSize(),this.addEventListeners(),this.reset(),this.resetToStart===!1&&(this.settings.startX=0,this.settings.startY=0)}static isSettingTrue(e){return e===""||e===!0||e===1}getElementListener(){if(this.fullPageListening)return window.document;if(typeof this.settings["mouse-event-element"]=="string"){const e=document.querySelector(this.settings["mouse-event-element"]);if(e)return e}return this.settings["mouse-event-element"]instanceof Node?this.settings["mouse-event-element"]:this.element}addEventListeners(){this.onMouseEnterBind=this.onMouseEnter.bind(this),this.onMouseMoveBind=this.onMouseMove.bind(this),this.onMouseLeaveBind=this.onMouseLeave.bind(this),this.onWindowResizeBind=this.onWindowResize.bind(this),this.onDeviceOrientationBind=this.onDeviceOrientation.bind(this),this.elementListener.addEventListener("mouseenter",this.onMouseEnterBind),this.elementListener.addEventListener("mouseleave",this.onMouseLeaveBind),this.elementListener.addEventListener("mousemove",this.onMouseMoveBind),(this.glare||this.fullPageListening)&&window.addEventListener("resize",this.onWindowResizeBind),this.gyroscope&&window.addEventListener("deviceorientation",this.onDeviceOrientationBind)}removeEventListeners(){this.elementListener.removeEventListener("mouseenter",this.onMouseEnterBind),this.elementListener.removeEventListener("mouseleave",this.onMouseLeaveBind),this.elementListener.removeEventListener("mousemove",this.onMouseMoveBind),this.gyroscope&&window.removeEventListener("deviceorientation",this.onDeviceOrientationBind),(this.glare||this.fullPageListening)&&window.removeEventListener("resize",this.onWindowResizeBind)}destroy(){clearTimeout(this.transitionTimeout),this.updateCall!==null&&cancelAnimationFrame(this.updateCall),this.element.style.willChange="",this.element.style.transition="",this.element.style.transform="",this.resetGlare(),this.removeEventListeners(),this.element.vanillaTilt=null,delete this.element.vanillaTilt,this.element=null}onDeviceOrientation(e){if(e.gamma===null||e.beta===null)return;this.updateElementPosition(),this.gyroscopeSamples>0&&(this.lastgammazero=this.gammazero,this.lastbetazero=this.betazero,this.gammazero===null?(this.gammazero=e.gamma,this.betazero=e.beta):(this.gammazero=(e.gamma+this.lastgammazero)/2,this.betazero=(e.beta+this.lastbetazero)/2),this.gyroscopeSamples-=1);const n=this.settings.gyroscopeMaxAngleX-this.settings.gyroscopeMinAngleX,i=this.settings.gyroscopeMaxAngleY-this.settings.gyroscopeMinAngleY,r=n/this.width,s=i/this.height,o=e.gamma-(this.settings.gyroscopeMinAngleX+this.gammazero),a=e.beta-(this.settings.gyroscopeMinAngleY+this.betazero),l=o/r,u=a/s;this.updateCall!==null&&cancelAnimationFrame(this.updateCall),this.event={clientX:l+this.left,clientY:u+this.top},this.updateCall=requestAnimationFrame(this.updateBind)}onMouseEnter(){this.updateElementPosition(),this.element.style.willChange="transform",this.setTransition()}onMouseMove(e){this.updateCall!==null&&cancelAnimationFrame(this.updateCall),this.event=e,this.updateCall=requestAnimationFrame(this.updateBind)}onMouseLeave(){this.setTransition(),this.settings.reset&&requestAnimationFrame(this.resetBind)}reset(){this.onMouseEnter(),this.fullPageListening?this.event={clientX:(this.settings.startX+this.settings.max)/(2*this.settings.max)*this.clientWidth,clientY:(this.settings.startY+this.settings.max)/(2*this.settings.max)*this.clientHeight}:this.event={clientX:this.left+(this.settings.startX+this.settings.max)/(2*this.settings.max)*this.width,clientY:this.top+(this.settings.startY+this.settings.max)/(2*this.settings.max)*this.height};let e=this.settings.scale;this.settings.scale=1,this.update(),this.settings.scale=e,this.resetGlare()}resetGlare(){this.glare&&(this.glareElement.style.transform="rotate(180deg) translate(-50%, -50%)",this.glareElement.style.opacity="0")}getValues(){let e,n;this.fullPageListening?(e=this.event.clientX/this.clientWidth,n=this.event.clientY/this.clientHeight):(e=(this.event.clientX-this.left)/this.width,n=(this.event.clientY-this.top)/this.height),e=Math.min(Math.max(e,0),1),n=Math.min(Math.max(n,0),1);let i=(this.reverse*(this.settings.max-e*this.settings.max*2)).toFixed(2),r=(this.reverse*(n*this.settings.max*2-this.settings.max)).toFixed(2),s=Math.atan2(this.event.clientX-(this.left+this.width/2),-(this.event.clientY-(this.top+this.height/2)))*(180/Math.PI);return{tiltX:i,tiltY:r,percentageX:e*100,percentageY:n*100,angle:s}}updateElementPosition(){let e=this.element.getBoundingClientRect();this.width=this.element.offsetWidth,this.height=this.element.offsetHeight,this.left=e.left,this.top=e.top}update(){let e=this.getValues();this.element.style.transform="perspective("+this.settings.perspective+"px) rotateX("+(this.settings.axis==="x"?0:e.tiltY)+"deg) rotateY("+(this.settings.axis==="y"?0:e.tiltX)+"deg) scale3d("+this.settings.scale+", "+this.settings.scale+", "+this.settings.scale+")",this.glare&&(this.glareElement.style.transform=`rotate(${e.angle}deg) translate(-50%, -50%)`,this.glareElement.style.opacity=`${e.percentageY*this.settings["max-glare"]/100}`),this.element.dispatchEvent(new CustomEvent("tiltChange",{detail:e})),this.updateCall=null}prepareGlare(){if(!this.glarePrerender){const e=document.createElement("div");e.classList.add("js-tilt-glare");const n=document.createElement("div");n.classList.add("js-tilt-glare-inner"),e.appendChild(n),this.element.appendChild(e)}this.glareElementWrapper=this.element.querySelector(".js-tilt-glare"),this.glareElement=this.element.querySelector(".js-tilt-glare-inner"),!this.glarePrerender&&(Object.assign(this.glareElementWrapper.style,{position:"absolute",top:"0",left:"0",width:"100%",height:"100%",overflow:"hidden","pointer-events":"none","border-radius":"inherit"}),Object.assign(this.glareElement.style,{position:"absolute",top:"50%",left:"50%","pointer-events":"none","background-image":"linear-gradient(0deg, rgba(255,255,255,0) 0%, rgba(255,255,255,1) 100%)",transform:"rotate(180deg) translate(-50%, -50%)","transform-origin":"0% 0%",opacity:"0"}),this.updateGlareSize())}updateGlareSize(){if(this.glare){const e=(this.element.offsetWidth>this.element.offsetHeight?this.element.offsetWidth:this.element.offsetHeight)*2;Object.assign(this.glareElement.style,{width:`${e}px`,height:`${e}px`})}}updateClientSize(){this.clientWidth=window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth,this.clientHeight=window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight}onWindowResize(){this.updateGlareSize(),this.updateClientSize()}setTransition(){clearTimeout(this.transitionTimeout),this.element.style.transition=this.settings.speed+"ms "+this.settings.easing,this.glare&&(this.glareElement.style.transition=`opacity ${this.settings.speed}ms ${this.settings.easing}`),this.transitionTimeout=setTimeout(()=>{this.element.style.transition="",this.glare&&(this.glareElement.style.transition="")},this.settings.speed)}extendSettings(e){let n={reverse:!1,max:15,startX:0,startY:0,perspective:1e3,easing:"cubic-bezier(.03,.98,.52,.99)",scale:1,speed:300,transition:!0,axis:null,glare:!1,"max-glare":1,"glare-prerender":!1,"full-page-listening":!1,"mouse-event-element":null,reset:!0,"reset-to-start":!0,gyroscope:!0,gyroscopeMinAngleX:-45,gyroscopeMaxAngleX:45,gyroscopeMinAngleY:-45,gyroscopeMaxAngleY:45,gyroscopeSamples:10},i={};for(var r in n)if(r in e)i[r]=e[r];else if(this.element.hasAttribute("data-tilt-"+r)){let s=this.element.getAttribute("data-tilt-"+r);try{i[r]=JSON.parse(s)}catch{i[r]=s}}else i[r]=n[r];return i}static init(e,n){e instanceof Node&&(e=[e]),e instanceof NodeList&&(e=[].slice.call(e)),e instanceof Array&&e.forEach(i=>{"vanillaTilt"in i||(i.vanillaTilt=new ui(i,n))})}}typeof document<"u"&&(window.VanillaTilt=ui,ui.init(document.querySelectorAll("[data-tilt]")));function hN({events:t,view:e,listRef:n,admin:i,onEdit:r,onDelete:s,onSelect:o,highlightId:a,loading:l=!1}){const[u,c]=En.useState(30);W.useEffect(()=>{c(30)},[t.length,e]);const f=En.useMemo(()=>function({ev:m,className:x="",isHighlighted:g=!1}){var w,A;const d=!!m.code||((w=m.tags)==null?void 0:w.includes("legendary")),v=d?m.color||"#f5c542":m.color||"#8b5cf6",_=En.useRef(null);W.useEffect(()=>{if(!_.current)return;const C=_.current;return ui.init(C,{max:6,speed:300,scale:1.02,perspective:1e3,glare:!1,gyroscope:!1,easing:"cubic-bezier(.03,.98,.52,.99)",reset:!0,transition:!0}),()=>{var R,T;try{(T=(R=C==null?void 0:C.vanillaTilt)==null?void 0:R.destroy)==null||T.call(R)}catch{}}},[]);const y=b.jsxs(tn.button,{"data-timeline-card":!0,tabIndex:0,onClick:()=>o(m),initial:!1,ref:_,className:Qr("group relative flex h-45 w-full flex-col overflow-hidden text-left rounded-3xl p-5 shadow-lg backdrop-blur transition hover:shadow-2xl focus:outline-none focus:ring-2 focus:ring-indigo-300",!d&&"transform-gpu transition-transform duration-200 ease-out","bg-white/70 dark:bg-white/5",!d&&"border border-black/5",x),style:{contentVisibility:"auto",containIntrinsicSize:"280px 180px",backgroundImage:`linear-gradient(180deg, ${v}0f, transparent 55%)`,...d?{boxShadow:`0 6px 20px ${v}33, 0 0 24px ${v}22, 0 0 8px ${v}11`}:{}},children:[g&&b.jsx(tn.div,{className:"absolute inset-0 rounded-3xl pointer-events-none",initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},style:{boxShadow:"0 0 0 0 transparent"}}),b.jsx("div",{"aria-hidden":!0,className:"absolute inset-0 rounded-3xl pointer-events-none transition-opacity opacity-0 group-hover:opacity-100",style:{zIndex:0,boxShadow:`0 12px 40px ${v}73, 0 0 60px ${v}55`,filter:"blur(60px)"}}),b.jsx("div",{className:"absolute inset-x-4 top-0 h-1 rounded-b-full",style:{background:v}}),b.jsxs("div",{className:"flex items-start justify-between gap-3",children:[b.jsxs("div",{className:"text-base font-semibold text-neutral-900 dark:text-white sm:text-lg flex items-center gap-1",children:[d&&b.jsx(gE,{size:16,className:"text-yellow-500"}),m.title]}),i&&b.jsxs("div",{className:"flex items-center gap-2 opacity-90",onClick:C=>C.stopPropagation(),children:[b.jsx(Lt,{variant:"soft",onClick:()=>r(m),children:b.jsx(eN,{size:16})}),b.jsx(Lt,{variant:"outline",onClick:()=>s(m),children:b.jsx(mE,{size:16})})]})]}),b.jsx("div",{className:"pt-1 text-sm text-neutral-700 dark:text-neutral-300",children:b.jsxs("span",{className:"inline-flex items-center gap-1 rounded-full bg-black/5 px-2 py-0.5 text-xs dark:bg-white/10",children:[b.jsx(X3,{size:14})," ",aN(m.date)]})}),m.description&&b.jsx("p",{className:"pt-3 text-sm leading-relaxed text-neutral-800 dark:text-neutral-200 line-clamp-1 whitespace-pre-line",children:m.description}),(A=m.tags)!=null&&A.length?b.jsx("div",{className:"mt-auto pt-3 flex flex-wrap gap-2",children:m.tags.map(C=>b.jsxs("span",{className:Qr("rounded-full px-2 py-0.5 text-xs",C==="legendary"?"bg-yellow-300/20 text-yellow-700 dark:text-yellow-300":"bg-indigo-500/10 text-indigo-700 dark:text-indigo-300"),style:{border:`1px solid ${v}55`},children:["#",C==="legendary"?"легендарное":C]},C))}):null]});return d?b.jsx(dN,{color:v,thickness:2,speed:1,chaos:.5,style:{borderRadius:24,width:"100%"},className:"block w-full rounded-3xl overflow-visible transform-gpu transition-transform duration-200 ease-out",children:y}):y},[i]);function h(){const p={};for(let m=0;m<12;m++)p[m]=[];for(const m of t)p[_E(m.date)].push(m);return b.jsx("div",{className:"grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3",children:xE.map((m,x)=>b.jsxs("div",{className:"rounded-3xl border border-black/10 bg-white/60 p-4 dark:border-white/10 dark:bg-white/5",children:[b.jsxs("div",{className:"mb-3 flex items-center justify-between",children:[b.jsx("div",{className:"font-semibold text-neutral-900 dark:text-white",children:m}),b.jsxs("div",{className:"text-xs opacity-60",children:[p[x].length," событий"]})]}),b.jsx("div",{className:"grid gap-2",children:p[x].length?p[x].map(g=>b.jsx(f,{ev:g,isHighlighted:a===g.id},g.id)):b.jsx("div",{className:"text-sm text-neutral-600 dark:text-neutral-400",children:"Нет событий"})})]},m))})}return b.jsx(Ho,{mode:"popLayout",children:e==="timeline"?b.jsxs(tn.div,{ref:n,className:"relative grid gap-5 sm:gap-6 md:grid-cols-2",children:[l&&t.length===0?b.jsx("div",{className:"col-span-full flex justify-center",children:b.jsx("div",{className:"w-full max-w-5xl",children:b.jsx(fN,{count:8})})}):t.length?t.slice(0,u).map((p,m)=>b.jsx(f,{ev:p,isHighlighted:a===p.id,className:Qr("transition-transform")},p.id)):b.jsx(tn.div,{initial:{opacity:0},animate:{opacity:1},className:"rounded-2xl border border-black/10 bg-white/70 p-6 text-center text-sm text-neutral-600 dark:border-white/10 dark:bg-white/5 dark:text-neutral-300",children:"Ничего не найдено. Попробуй изменить фильтры или добавить событие."}),!l&&e==="timeline"&&t.length>u&&b.jsx("div",{className:"col-span-full flex justify-center",children:b.jsx(Lt,{variant:"soft",onClick:()=>c(p=>p+20),children:"Показать ещё"})})]}):b.jsx(h,{})})}function pN(t){const[e,n]=W.useState(""),[i,r]=W.useState("all"),[s,o]=W.useState("all"),[a,l]=W.useState([]),[u,c]=W.useState("timeline"),f=W.useMemo(()=>{const v=new Set;for(const _ of t)_.tags.forEach(y=>v.add(y));return Array.from(v).sort((_,y)=>_.localeCompare(y))},[t]),h=W.useMemo(()=>{const v=new Set;for(const _ of t)v.add(X0(_.date));return Array.from(v).sort((_,y)=>_-y)},[t]),p=W.useDeferredValue(e),m=W.useMemo(()=>{const v=p.trim().toLowerCase();return t.filter(_=>i==="all"?!0:X0(_.date)===i).filter(_=>s==="all"?!0:_E(_.date)===s).filter(_=>a.length?a.every(y=>_.tags.map(w=>w.toLowerCase()).includes(y.toLowerCase())):!0).filter(_=>v?[_.title,_.description,_.tags.join(" ")].filter(Boolean).some(y=>y.toLowerCase().includes(v)):!0).sort((_,y)=>new Date(_.date).getTime()-new Date(y.date).getTime())},[t,p,i,s,a]),x=i==="all"?-1:h.indexOf(i);function g(){x>0&&r(h[x-1])}function d(){x<h.length-1&&r(h[x+1])}return{query:e,setQuery:n,year:i,setYear:r,month:s,setMonth:o,activeTags:a,setActiveTags:l,view:u,setView:c,allTags:f,years:h,filtered:m,prevYear:g,nextYear:d}}function mN(){const[t,e]=W.useState(!1),[n,i]=W.useState(!1),[r,s]=W.useState("login"),[o,a]=W.useState(!1),[l,u]=W.useState(null),[c,f]=W.useState(!1),[h,p]=W.useState(null),[m,x]=W.useState(null),[g,d]=W.useState(!1),[v,_]=W.useState(null),[y,w]=W.useState(!1),[A,C]=W.useState(!1);return W.useEffect(()=>{function R(T){const E=(T==null?void 0:T.detail)==="register"?"register":"login";s(E)}return window.addEventListener("switch-auth-mode",R),()=>window.removeEventListener("switch-auth-mode",R)},[]),{dialogOpen:t,setDialogOpen:e,authOpen:n,setAuthOpen:i,authMode:r,setAuthMode:s,logoutConfirmOpen:o,setLogoutConfirmOpen:a,editing:l,setEditing:u,detailOpen:c,setDetailOpen:f,selected:h,setSelected:p,imagePreview:m,setImagePreview:x,settingsOpen:g,setSettingsOpen:d,usersOpen:y,setUsersOpen:w,adminOpen:A,setAdminOpen:C,deleting:v,setDeleting:_}}const gN=En.lazy(()=>oc(()=>import("./AuthDialog-DFSj0FNQ.js"),__vite__mapDeps([0,1]))),vN=En.lazy(()=>oc(()=>import("./AddDialog-CHteESKI.js"),__vite__mapDeps([2,3,1]))),_N=En.lazy(()=>oc(()=>import("./DetailDialog-Bw-qQIDB.js"),__vite__mapDeps([4,1]))),xN=En.lazy(()=>oc(()=>import("./AdminDialog-kQw2nq1P.js"),__vite__mapDeps([5,3]))),$0="life-timeline-theme",Uf="life-timeline-events-cache",Vl=["Собираем лепестки воспоминаний…","Подкрашиваем таймлайн и теги…","Синхронизируем события с сервером…","Проверяем секреты и легендарные моменты…","Настраиваем фильтры и поиск…","Вспоминаем всё на свете…","Считаем дни и минуты…","Апаем 10-й лвл… (KD 4/19)"];function yN(){const[t]=W.useState(()=>{var J;if(typeof window>"u")return!0;const O=localStorage.getItem($0);return O?O==="dark":(J=window.matchMedia)==null?void 0:J.call(window,"(prefers-color-scheme: dark)").matches});W.useEffect(()=>{document.documentElement.classList.toggle("dark",t),localStorage.setItem($0,t?"dark":"light")},[t]);const[e,n]=W.useState(()=>{if(typeof window>"u")return[];try{const O=localStorage.getItem(Uf);if(!O)return[];const J=JSON.parse(O);return Array.isArray(J)?J:[]}catch{return[]}}),[i,r]=W.useState(null),[s,o]=W.useState(!0),[a,l]=W.useState(!1),u=!!i,c=(i==null?void 0:i.role)==="admin";async function f(){try{const O=await Wn.me();r(O.user)}catch{r(null)}finally{o(!1)}}async function h(){try{l(!0);const J=(await Wn.getEvents()).events||[];n(J);try{localStorage.setItem(Uf,JSON.stringify(J))}catch{}}catch{n([])}finally{l(!1)}}W.useEffect(()=>{f()},[]),W.useEffect(()=>{if(!s)if(i)h();else{n([]),l(!1);try{localStorage.removeItem(Uf)}catch{}}},[i,s]);const{query:p,setQuery:m,year:x,setYear:g,month:d,setMonth:v,activeTags:_,setActiveTags:y,view:w,allTags:A,years:C,filtered:R,prevYear:T,nextYear:E}=pN(e),{dialogOpen:D,setDialogOpen:$,authOpen:j,setAuthOpen:V,authMode:te,setAuthMode:G,logoutConfirmOpen:ee,setLogoutConfirmOpen:N,editing:q,setEditing:Q,detailOpen:fe,setDetailOpen:ve,selected:Ye,setSelected:Ve,imagePreview:X,setImagePreview:le,settingsOpen:se,setSettingsOpen:Se,adminOpen:Te,setAdminOpen:Pe,deleting:We,setDeleting:ke}=mN(),[L,qe]=W.useState(!1),[Re,je]=W.useState(""),[Ee,Je]=W.useState(null),[ge,Be]=W.useState(null),[bt,pt]=W.useState(null),P=W.useMemo(()=>({enabledWaves:["top","middle","bottom"],lineCount:[8,8,8],lineDistance:[30,30,30]}),[]);W.useRef(0);const[S,k]=W.useState(!1),[Z,ne]=W.useState(()=>Math.floor(Math.random()*Vl.length));W.useEffect(()=>{if(a&&u){k(!0);try{document.body.style.overflow="hidden"}catch{}}else{try{document.body.style.overflow=""}catch{}const O=setTimeout(()=>k(!1),150);return()=>clearTimeout(O)}},[a,u]),W.useEffect(()=>{S&&ne(Math.floor(Math.random()*Vl.length))},[S]),W.useEffect(()=>{if(!X)return;const O=J=>{J.key==="Escape"&&le(null)};return window.addEventListener("keydown",O),()=>window.removeEventListener("keydown",O)},[X,le]);const K=En.useCallback(O=>{Ve(O),ve(!0)},[Ve,ve]);W.useEffect(()=>{const O=["ArrowUp","ArrowUp","ArrowDown","ArrowDown","ArrowLeft","ArrowRight","ArrowLeft","ArrowRight"];let J=0;function ce(ie){ie.key===O[J]?(J++,J===O.length&&(qe(!0),J=0)):J=0}return window.addEventListener("keydown",ce),()=>window.removeEventListener("keydown",ce)},[]);const we=W.useRef(null);W.useEffect(()=>{function O(J){var Y,ye;if(!we.current)return;const ce=Array.from(we.current.querySelectorAll("[data-timeline-card]")),ie=ce.findIndex(Ue=>Ue===document.activeElement);if(J.key==="ArrowDown"){J.preventDefault();const Ue=Math.min(ce.length-1,ie+1);(Y=ce[Ue]||ce[0])==null||Y.focus()}else if(J.key==="ArrowUp"){J.preventDefault();const Ue=Math.max(0,ie-1);(ye=ce[Ue]||ce[ce.length-1])==null||ye.focus()}}return window.addEventListener("keydown",O),()=>window.removeEventListener("keydown",O)},[]);const ue=W.useRef(null),Ae=()=>{var O;return(O=ue.current)==null?void 0:O.scrollIntoView({behavior:"smooth",block:"start"})};function Ce(O){(async()=>{try{e.some(ce=>ce.id===O.id)?await Wn.updateEvent(O.id,O):await Wn.createEvent(O),await h()}catch(J){alert("Ошибка сохранения: "+((J==null?void 0:J.message)||"unknown"))}})()}function oe(O){(async()=>{try{if(!FS(O)){alert("Нельзя удалить локальное/несинхронизированное событие — у него нет серверного ID.");return}await Wn.deleteEvent(O),await h()}catch(J){alert("Ошибка удаления: "+((J==null?void 0:J.message)||"unknown"))}})()}function pe(){c&&confirm("Удалить все события на сервере?")&&(async()=>{try{await Promise.all(e.map(O=>Wn.deleteEvent(O.id))),await h()}catch(O){alert("Ошибка очистки: "+((O==null?void 0:O.message)||"unknown"))}})()}async function Ne(){try{const O=await Wn.unlockEvent(Re.trim());await h(),qe(!1),je(""),Be(O.event),pt(O.event.id),setTimeout(()=>pt(null),4e3)}catch(O){(O==null?void 0:O.message)==="invalid_code"?Je("Неверный код"):(O==null?void 0:O.message)==="already_unlocked"?Je("У вас уже есть это событие"):Je("Ошибка, попробуйте позже")}}function be(O){if(!c)return;const J=new FileReader;J.onload=async()=>{try{const ce=JSON.parse(String(J.result));if(Array.isArray(ce)){const ie=ce.filter(Y=>Y&&Y.date&&Y.title).map(Y=>({id:Y.id||oN(),date:Y.date,title:Y.title,description:Y.description||"",tags:Array.isArray(Y.tags)?Y.tags:[],color:Y.color||void 0,emoji:Y.emoji||void 0,imageData:Y.imageData||void 0,code:Y.code||void 0}));for(const Y of ie)try{await Wn.createEvent(Y)}catch{}await h()}else alert("Ожидался массив событий")}catch{alert("Не удалось прочитать JSON")}},J.readAsText(O)}function de(){G("login"),V(!0)}function ze(){N(!0)}const I=Vl[Z]??Vl[0];return b.jsxs("div",{className:"min-h-dvh bg-gradient-to-br from-indigo-50 via-white to-rose-50 text-neutral-900 transition dark:from-[#0B0B12] dark:via-[#0B0B12] dark:to-[#14121B] dark:text-white",children:[b.jsx("style",{children:`
                  ...
                  `}),b.jsxs("header",{className:"relative isolate min-h-[100svh] overflow-hidden",children:[b.jsx(Rb,{}),b.jsx("div",{className:"pointer-events-none absolute inset-0 -z-10","aria-hidden":!0,children:b.jsx(V3,{enabledWaves:P.enabledWaves,lineCount:P.lineCount,lineDistance:P.lineDistance,bendRadius:5,bendStrength:-.5,animationSpeed:.8,parallax:!0,parallaxStrength:.2})}),b.jsx("div",{className:"pointer-events-none absolute inset-x-0 bottom-0 z-0 h-32 bg-gradient-to-b from-transparent via-white/70 to-white dark:via-neutral-900/60 dark:to-neutral-950"}),b.jsx("div",{className:"pointer-events-none absolute inset-0 -z-20 opacity-40 [background:radial-gradient(600px_200px_at_10%_-10%,#a78bfa,transparent_60%),radial-gradient(600px_200px_at_90%_-10%,#f472b6,transparent_60%)]"}),b.jsx("div",{className:"absolute inset-x-0 top-0 z-20",children:b.jsxs("div",{className:"mx-auto flex max-w-6xl items-center justify-between px-4 py-4",children:[b.jsxs("div",{className:"inline-flex items-center gap-2 rounded-full border border-black/10 bg-white/70 px-3 py-1 text-xs backdrop-blur dark:border-white/10 dark:bg-white/10 cursor-default",children:[b.jsx(Yo,{size:14})," Eternal May"]}),b.jsxs("div",{className:"relative flex items-center gap-2",children:[b.jsxs("div",{className:"relative",children:[b.jsxs(Lt,{variant:"outline",onClick:()=>Se(O=>!O),children:[b.jsx(iN,{size:16})," Настройки"]}),se&&b.jsxs("div",{className:"absolute right-0 z-30 mt-2 w-56 overflow-hidden rounded-2xl border border-black/10 bg-white/95 p-2 shadow-xl backdrop-blur dark:border-white/10 dark:bg-neutral-900/95",children:[b.jsxs("button",{className:"flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm hover:bg-black/5 dark:hover:bg-white/10",onClick:()=>Y0("events.json",JSON.stringify(e,null,2)),children:[b.jsx(K3,{size:16})," Экспорт JSON"]}),b.jsxs("button",{className:"flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm hover:bg-black/5 dark:hover:bg-white/10",onClick:()=>Y0("events.ics",lN(e),"text/calendar"),children:[b.jsx(q3,{size:16})," Экспорт iCal"]}),c&&b.jsxs(b.Fragment,{children:[b.jsxs("button",{className:"flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm hover:bg-black/5 dark:hover:bg-white/10",onClick:()=>{Se(!1),Pe(!0)},children:[b.jsx(sN,{size:16})," Админ-панель"]}),b.jsxs("label",{className:"flex w-full cursor-pointer items-center gap-2 rounded-xl px-3 py-2 text-sm hover:bg-black/5 dark:hover:bg-white/10",children:[b.jsx(rN,{size:16})," Импорт JSON",b.jsx("input",{type:"file",className:"hidden",accept:"application/json",onChange:O=>{var ce;const J=(ce=O.target.files)==null?void 0:ce[0];J&&be(J),O.currentTarget.value=""}})]}),b.jsxs("button",{className:"flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20",onClick:pe,children:[b.jsx(mE,{size:16})," Очистить всё"]})]})]})]}),u?b.jsxs(b.Fragment,{children:[b.jsxs("div",{className:"hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/70 dark:bg-white/10 border border-black/10 dark:border-white/10 text-xs",children:[b.jsx("span",{className:"inline-block w-2 h-2 rounded-full bg-emerald-500"}),i==null?void 0:i.email]}),b.jsxs(Lt,{variant:"outline",onClick:ze,children:[b.jsx(J3,{size:16})," Выйти"]})]}):b.jsxs(Lt,{variant:"outline",onClick:de,children:[b.jsx(W0,{size:16})," Войти"]})]})]})}),b.jsxs("div",{className:"relative z-10 mx-auto flex min-h-[100svh] max-w-6xl flex-col items-center justify-center px-4 text-center",children:[b.jsxs(tn.h1,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{duration:.6},className:"relative text-4xl font-black tracking-tight sm:text-6xl md:text-7xl cursor-default select-none",style:{textShadow:"0 0 16px #a78bfa88, 0 0 32px #f472b688, 0 2px 8px #fff, 0 0 2px #fff"},children:[b.jsx("span",{className:"relative z-10",children:"Экскурсия в мой мир"}),b.jsx(tn.span,{"aria-hidden":!0,className:"pointer-events-none absolute inset-0 z-0",style:{"--mid":"40%","--end":"80%",background:"radial-gradient(ellipse at 50% 60%, #a78bfa55 0%, #f472b655 var(--mid), transparent var(--end))",filter:"blur(24px)",opacity:.3,mixBlendMode:"screen"},animate:{"--mid":["40%","60%","40%"],"--end":["80%","90%","80%"]},transition:{duration:6,ease:"easeInOut",repeat:1/0}})]}),b.jsx(tn.p,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{duration:.6,delay:.05},className:"mt-6 max-w-2xl text-base leading-relaxed text-neutral-700 dark:text-neutral-300 cursor-default",children:"Таймлайн важных событий моей жизни. Фильтры, поиск, теги и красивый просмотр деталей."}),b.jsx("div",{className:"pointer-events-none absolute inset-x-0 bottom-6 z-10 flex items-center justify-center",children:b.jsxs(Lt,{className:"pointer-events-auto backdrop-blur",variant:"soft",onClick:Ae,children:[b.jsx(j3,{size:16})," Перейти к событиям"]})})]})]}),b.jsxs("main",{ref:ue,className:"relative mx-auto max-w-6xl mt-6 px-4 pb-24",children:[b.jsxs("div",{"aria-hidden":!0,className:"pointer-events-none absolute inset-0 -z-20 overflow-hidden",children:[b.jsx("div",{className:"absolute left-1/2 top-0 h-[160%] w-[200%] -translate-x-1/2 [background:radial-gradient(ellipse_at_20%_-10%,rgba(167,139,250,0.35),transparent_55%),radial-gradient(ellipse_at_80%_-5%,rgba(244,114,182,0.28),transparent_55%)] dark:[background:radial-gradient(ellipse_at_15%_-10%,rgba(124,115,255,0.25),transparent_60%),radial-gradient(ellipse_at_85%_-5%,rgba(236,72,153,0.25),transparent_60%)]"}),b.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-white/95 via-white to-white dark:from-[#0b0b12]/95 dark:via-[#090910] dark:to-[#07070c]"})]}),b.jsx("div",{"aria-hidden":!0,className:"pointer-events-none absolute inset-x-0 top-0 -z-10 h-32 overflow-hidden",children:b.jsx("div",{className:"absolute left-1/2 top-0 h-32 w-[140%] -translate-x-1/2 -translate-y-1/2 bg-gradient-to-b from-transparent via-white/80 to-white dark:via-neutral-950/80 dark:to-neutral-950 sm:w-[160%]"})}),u?b.jsxs(b.Fragment,{children:[b.jsx(uN,{query:p,setQuery:m,year:x,setYear:g,month:d,setMonth:v,activeTags:_,setActiveTags:y,years:C,allTags:A,resetFilters:()=>{y([]),g("all"),v("all"),m("")},resultsCount:R.length,admin:c,onAdd:()=>{Q(null),$(!0)}}),x!=="all"&&b.jsxs("div",{className:"mb-4 flex items-center justify-between",children:[b.jsxs(Lt,{variant:"soft",onClick:T,children:[b.jsx(Y3,{size:16})," Предыдущий"]}),b.jsx("div",{className:"rounded-full border border-black/10 bg-white/70 px-4 py-1 text-sm shadow-sm dark:border-white/10 dark:bg-white/10",children:x}),b.jsxs(Lt,{variant:"soft",onClick:E,children:["Следующий ",b.jsx($3,{size:16})]})]}),b.jsx(hN,{events:R,view:w,listRef:we,admin:c,loading:a,onEdit:O=>{Q(O),$(!0)},onDelete:O=>ke(O),onSelect:K,highlightId:bt})]}):b.jsx("div",{className:"mx-auto max-w-2xl",children:b.jsxs("div",{className:"rounded-3xl border border-black/10 bg-white/70 p-6 text-center shadow-sm backdrop-blur dark:border-white/10 dark:bg-white/5",children:[b.jsxs("div",{className:"mx-auto mb-3 inline-flex items-center justify-center gap-2 text-lg font-semibold",children:[b.jsx(G0,{className:"text-yellow-500",size:18}),"Доступ к событиям только для авторизованных"]}),b.jsx("p",{className:"mx-auto max-w-md text-sm text-neutral-700 dark:text-neutral-300",children:"Вы не увидите события, пока не войдёте в аккаунт. Войдите или создайте аккаунт, чтобы продолжить."}),b.jsxs("div",{className:"mt-5 flex flex-col items-center justify-center gap-2 sm:flex-row",children:[b.jsxs(Lt,{onClick:()=>{G("login"),V(!0)},children:[b.jsx(W0,{size:16})," Войти"]}),b.jsxs(Lt,{variant:"outline",onClick:()=>{G("register"),V(!0)},children:[b.jsx(Yo,{size:16})," Создать аккаунт"]})]})]})})]}),b.jsx(En.Suspense,{fallback:null,children:b.jsx(Ho,{children:j&&b.jsx(gN,{open:j,mode:te,onClose:()=>V(!1),onSuccess:async()=>{await f()},login:Wn.login,register:Wn.register})})}),b.jsx(j0,{open:!!We,title:"Удалить событие?",description:`Событие «${We==null?void 0:We.title}» будет удалено безвозвратно.`,confirmText:"Удалить",onConfirm:()=>{We&&oe(We.id),ke(null),ve(!1),Ve(null)},onCancel:()=>ke(null)}),b.jsx(j0,{open:ee,title:"Выйти из аккаунта?",description:"Сессия будет завершена, действия администратора станут недоступны.",confirmText:"Выйти",onConfirm:async()=>{try{await Wn.logout()}finally{r(null),N(!1)}},onCancel:()=>N(!1)}),b.jsx(En.Suspense,{fallback:null,children:b.jsx(vN,{open:D,initial:q,onClose:()=>{$(!1),Q(null)},onSubmit:O=>{Ce(O),$(!1),Q(null)}})}),b.jsx(En.Suspense,{fallback:null,children:b.jsx(_N,{open:fe,event:Ye,admin:c,onClose:()=>ve(!1),onEdit:O=>{Q(O),$(!0),ve(!1)},onDelete:O=>ke(O),onImagePreview:O=>le(O)})}),b.jsx(En.Suspense,{fallback:null,children:b.jsx(xN,{open:Te,onClose:()=>Pe(!1)})}),b.jsx($o,{open:L,onClose:()=>qe(!1),children:b.jsxs("div",{className:"p-6 grid gap-4",children:[b.jsxs("h3",{className:"text-lg font-semibold flex items-center gap-2",children:[b.jsx(Yo,{size:18})," Введите код"]}),b.jsx(vE,{value:Re,onChange:O=>je(O.target.value)}),b.jsxs("div",{className:"flex justify-end gap-2",children:[b.jsx(Lt,{variant:"outline",onClick:()=>qe(!1),children:"Отмена"}),b.jsxs(Lt,{onClick:Ne,children:[b.jsx(Yo,{size:16})," Разблокировать"]})]})]})}),b.jsx($o,{open:!!Ee,onClose:()=>Je(null),children:Ee&&b.jsxs("div",{className:"p-6 grid gap-4",children:[b.jsxs("h3",{className:"text-lg font-semibold flex items-center gap-2",children:[b.jsx(G0,{className:"text-red-500",size:18})," Ошибка"]}),b.jsx("p",{className:"text-sm opacity-80",children:Ee}),b.jsx("div",{className:"flex justify-end",children:b.jsx(Lt,{onClick:()=>Je(null),children:"Ок"})})]})}),b.jsx(Ho,{children:b.jsx($o,{open:!!ge,onClose:()=>Be(null),children:ge&&b.jsxs("div",{className:"p-6 flex flex-col items-center text-center gap-4",children:[b.jsx(tn.div,{initial:{scale:0,rotate:-90},animate:{scale:1,rotate:0},transition:{type:"spring",stiffness:260,damping:20},className:"text-yellow-500",children:b.jsx(gE,{size:48})}),b.jsx("div",{className:"text-lg font-semibold",children:"Легендарное событие разблокировано!"}),b.jsx("div",{className:"text-sm opacity-80",children:ge.title}),b.jsx(Lt,{onClick:()=>Be(null),children:"Круто!"})]})})}),b.jsx(Ho,{children:S&&b.jsxs(tn.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},className:"fixed inset-0 z-[120] overflow-hidden bg-gradient-to-br from-white/70 via-white/80 to-rose-50/80 backdrop-blur-2xl dark:from-[#03030a]/95 dark:via-[#090512]/95 dark:to-[#140c1f]/95",children:[b.jsxs("div",{className:"pointer-events-none absolute inset-0",children:[b.jsx("div",{className:"absolute -left-24 top-10 h-64 w-64 rounded-full bg-indigo-200/60 blur-3xl dark:bg-indigo-700/30"}),b.jsx("div",{className:"absolute bottom-0 right-[-10%] h-72 w-72 rounded-full bg-rose-200/70 blur-3xl dark:bg-rose-700/30"}),b.jsx("div",{className:"absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(167,139,250,0.25),transparent_55%),radial-gradient(circle_at_70%_20%,rgba(244,114,182,0.25),transparent_50%)] dark:bg-[radial-gradient(circle_at_30%_20%,rgba(124,115,255,0.2),transparent_60%),radial-gradient(circle_at_75%_15%,rgba(236,72,153,0.25),transparent_55%)]"})]}),b.jsxs(tn.div,{initial:{scale:.95,opacity:0},animate:{scale:1,opacity:1},exit:{scale:.96,opacity:0},transition:{type:"spring",stiffness:220,damping:25},className:"relative z-10 mx-auto mt-20 flex w-[min(90vw,420px)] flex-col items-center gap-5 rounded-[28px] border border-white/60 bg-white/85 px-8 py-10 text-center shadow-2xl backdrop-blur-lg dark:border-white/10 dark:bg-neutral-900/85",children:[b.jsx("div",{className:"text-[11px] uppercase tracking-[0.45em] text-indigo-500/80 dark:text-indigo-200/70",children:"Eternal May"}),b.jsxs("div",{className:"relative h-20 w-20",children:[b.jsx(tn.span,{className:"absolute inset-0 rounded-full border-2 border-indigo-300/50 dark:border-indigo-400/30",animate:{rotate:360},transition:{duration:8,repeat:1/0,ease:"linear"}}),b.jsx(tn.span,{className:"absolute inset-3 rounded-full border-2 border-rose-300/60 dark:border-rose-300/30",animate:{rotate:-360},transition:{duration:6,repeat:1/0,ease:"linear"}}),b.jsx("span",{className:"absolute inset-6 rounded-full bg-gradient-to-br from-indigo-400/35 to-rose-400/35 blur-xl"}),b.jsx(Q3,{className:"absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-indigo-600 dark:text-rose-100",size:30})]}),b.jsx("div",{className:"text-lg font-semibold text-neutral-900 dark:text-white",children:"Бережно раскладываем события"}),b.jsx(tn.p,{initial:{opacity:0,y:6},animate:{opacity:1,y:0},transition:{duration:.35},className:"text-sm text-neutral-700/80 dark:text-neutral-300/80",children:I},Z),b.jsx("div",{className:"mt-2 h-1.5 w-full overflow-hidden rounded-full bg-neutral-900/10 dark:bg-white/10",children:b.jsx(tn.span,{initial:{width:"0%"},animate:{width:"100%"},transition:{duration:2,ease:"easeInOut",repeat:1/0},className:"block h-full rounded-full bg-gradient-to-r from-indigo-400 via-violet-400 to-rose-400"},`bar-${Z}`)})]})]})}),b.jsx(Ho,{children:b.jsx($o,{open:!!X,onClose:()=>le(null),children:X&&b.jsx("div",{className:"flex items-center justify-center p-4",children:b.jsx("img",{src:X,alt:"Превью",className:"max-h-[80vh] w-auto max-w-[90vw] object-contain"})})})}),b.jsxs("footer",{className:"mx-auto max-w-6xl px-4 pb-10 pt-6 text-xs flex flex-col items-center text-center opacity-20 cursor-default",children:[b.jsx("div",{children:"Не уходи безропотно во тьму,"}),b.jsx("div",{children:"Будь яростней пред ночью всех ночей,"}),b.jsx("div",{children:"Не дай погаснуть свету своему!"})]})]})}Ff.createRoot(document.getElementById("root")).render(b.jsx(En.StrictMode,{children:b.jsx(yN,{})}));export{Lt as B,Y3 as C,$o as D,vE as I,W0 as L,eN as P,En as R,Yo as S,EN as T,sN as U,Qr as a,$3 as b,Dt as c,Oo as d,X3 as e,aN as f,mE as g,Wn as h,nN as i,b as j,tN as k,j0 as l,W as r,oN as u};
